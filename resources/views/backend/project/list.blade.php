...
@section('breadcrumbs')
    {!! Breadcrumbs::render('list_project') !!}
@endsection
...
<div class="row">
    <div class="col-xs-12">
        ...
        @endif
        <a class="btn btn-primary btn-md" href="{{ route('backend::project.create') }}">
	...
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<div class="modal-body">
				<div class="row">
					<div class="col-md-12">
						Apakah benar data {{$res->nama_project}} akan di hapus?
					</div>
				</div>
			</div>

			<div class="modal-footer">
                <form method="POST" action="{{ route('backend::project.destroy', ['id'=>$res->id]) }}" accept-charset="UTF-8">
